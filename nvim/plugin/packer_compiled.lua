...
_G.packer_plugins = {
  Alduin = {
    loaded = true,
    path = "/home/jake/.local/share/nvim/site/pack/packer/start/Alduin",
  ...
  ["fidget.nvim"] = {
    loaded = true,
    path = "/home/jake/.local/share/nvim/site/pack/packer/start/fidget.nvim",
  ...
  nerdcommenter = {
    loaded = true,
    path = "/home/jake/.local/share/nvim/site/pack/packer/start/nerdcommenter",
  ...
  ["rust.vim"] = {
    loaded = true,
    path = "/home/jake/.local/share/nvim/site/pack/packer/start/rust.vim",
  ...
  ["telescope-fzf-native.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = true,
    path = "/home/jake/.local/share/nvim/site/pack/packer/opt/telescope-fzf-native.nvim",
  ...
  ["vim-startify"] = {
    loaded = true,
    path = "/home/jake/.local/share/nvim/site/pack/packer/start/vim-startify",
