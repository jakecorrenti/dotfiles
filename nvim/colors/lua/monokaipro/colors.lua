...
function M.setup(config)
	...
	derivedColors = {
		...
		diff = {
			add = util.darken(c.green, 0.25),
			change = util.darken(c.orange, 0.25),
			delete = util.darken(c.red, 0.25),
			text = util.darken(c.cyan, 0.15),
		},
		...
		gitSigns = {
			add = util.darken(c.green, 0.75),
			change = util.darken(c.orange, 0.75),
			delete = util.darken(c.red, 0.75),
		},
