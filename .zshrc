...
export ZSH="/home/jakecorrenti/.oh-my-zsh"
...
# automatically start a tmux session when the terminal opens
# if command -v tmux>/dev/null; then
#     [[ ! $TERM =~ screen ]] && [ -z $TMUX ] && tmux
# fi
export PATH="/usr/local/opt/gnu-getopt/bin:$PATH"

alias luamake=/Users/jakecorrenti/lua-language-server/3rd/luamake/luamake
alias config='/usr/bin/git --git-dir=/Users/jakecorrenti/.config/ --work-tree=/Users/jakecorrenti'
